...
SH
  ...
  mkdir -p "$root/var/lib/omarchy" "$root/var/lib/pacman/local/linux-aurora-7.1.12.aurora2-6"
  ...
  printf '%%SHA256SUM%%\n%s\n' "$archive_sha" >"$root/var/lib/pacman/local/linux-aurora-7.1.12.aurora2-6/desc"
