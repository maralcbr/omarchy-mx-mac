...
3. Pick a channel. `stable` is the default for new users; `rc` carries the Aurora kernel with better external-display support. See [Channels and updates]({{page:channels}}).
