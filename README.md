...
the earlier Stable image, `os-v4.0.3-mac.1.20260913` (Omarchy 4.0.3, Asahi), which
Macs installed before then still run. The app follows the latest signed catalog for the channel you select;
