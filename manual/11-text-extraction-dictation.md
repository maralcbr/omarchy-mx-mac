...
The prebuilt Voxtype binary installs on x86_64 and on Apple Silicon. On an architecture without one, the installer offers to build Voxtype from source via the AUR instead, which takes 10-20 minutes.
