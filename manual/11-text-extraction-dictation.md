...
The prebuilt Voxtype binary is x86_64 only. On other architectures, such as Apple Silicon, the installer offers to build Voxtype from source via the AUR instead, which takes 10-20 minutes.
