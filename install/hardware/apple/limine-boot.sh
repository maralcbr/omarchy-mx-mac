...
# omarchy:heredoc-expands paths=none -- ESP_PATH names $esp, which the findmnt check above requires to be a mount target; kernel is pattern-checked by omarchy-hw-apple-kernel
